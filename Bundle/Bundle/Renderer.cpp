...
Renderer::Renderer(HINSTANCE hInstance)
	...
	mBundleObject(D3D12_COMMAND_LIST_TYPE_BUNDLE)
{
	renderer = this;
...
void Renderer::Initialize()
{
	...
	mBundleObject.CreateCommandAllocator(device);
	mBundleObject.CreateGraphicsCommandList(device);
	...
	ID3D12PipelineState* pipelineState)
{
	...
	{
		auto bundle = mBundleObject.GetCommandList();
		...
		bundle->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST);
		...
		mBundleObject.ResetCommandList();
	}
}